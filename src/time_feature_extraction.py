...
root_dir = "F:/"
TIME_FEATURE_DIM = 6
output_time_feature_file = root_dir + "time_feature.pkl"
...
def time_feature_extraction(time):
    ...
    hour = int((time - day * 24 * 12) / 12)
    min = time - day * 24 * 12 - hour * 12
...
TOTAL_TIME = 61 * 24 * 12  # 61 days * 24 hours * 12 mins(5 min interval)
